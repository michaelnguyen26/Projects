...
public class EventBus {
    ...
    /** Part B:
     * Command event #7 definition: check for overbooked classes. 
     */
    ...
    /** Part C:
     * Command event #8 definition: announce for schedule conflicts. 
     * Command event #9 definition: check for schedule conflicts. 
     */

    public static final int EV_CONFLICT = 8;

    public static final int EV_CHECK_FOR_CONFLICT = 9;
