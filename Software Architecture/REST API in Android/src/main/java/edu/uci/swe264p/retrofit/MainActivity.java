...
public class MainActivity extends AppCompatActivity {
    ...
    final static String API_KEY = "18d116f1f3ca3dc2e7970df2074c6d92";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // each window is its own activity, in this case the main window upon opening the app
        ...
        btnMovieList.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // request and intent that changes the activity on screen to MovieListActivity
